...
@section('title', config('app.name').' | Tambah Penerima Manfaat Pensiunan')
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Tambah Penerima Manfaat Pensiunan</h2>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Tambah Penerima Manfaat Pensiunan</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Tambah Penerima Manfaat Pensiunan</h5>
                    ...
                    <form method="post" action="{{ url()->current() }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row" id="data_1">
                            ...
                            <div class="col-lg-3 input-group date" id="data_1">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control" name="tgl_kk">
                            </div>
                        </div>
                        <div class="form-group row" id="data_1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="kota_tinggal">
                            </div>
                            <div class="col-lg-3">
                                <input type="text" class="form-control" name="pos_tinggal">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3">
                                <input type="text" class="form-control" name="pos_domisili">
                            </div>
                            <div class="col-lg-3">

...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ url('kepesertaan/manfaatpensiunan/kalkulasidaftarmp') }}">Kalkulasi Daftar Pembayaran Manfaat Pensiun</a>
            </li>
            <li class="breadcrumb-item active">
                <strong>Detail Kalkulasi Daftar Pembayaran Manfaat Pensiun</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Detail Kalkulasi Daftar Pembayaran Manfaat Pensiun</h5>

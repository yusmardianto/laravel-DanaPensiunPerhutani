...
@section('title', config('app.name').' | Data Transaksi Investasi')
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Data Transaksi Investasi</h2>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Data Transaksi Investasi</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Data Transaksi Investasi</h5>

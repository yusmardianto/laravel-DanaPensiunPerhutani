...
@section('title', config('app.name').' | Tambah Pemasukan Kas')
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ url('keuangan/pemasukan') }}">Daftar Pemasukan Kas</a>
            </li>
            <li class="breadcrumb-item active">
                <strong>Tambah Pemasukan Kas</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
                ...
                <div class="ibox-content">
                    ...
                    <form method="post" action="{{ url()->current() }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="no_trxIn" id="ktp" value="{{ $data->no_trxIn }}">
                            </div>
                        </div>
                        <div class="form-group row" id="data_1">
                            <label class="col-sm-2 col-form-label">Tanggal Transaksi</label>
                            <div class="col-lg-10 input-group date">
                                <input type="text" class="form-control" name="tgl_trxIn" value="{{ $data->tgl_trxIn }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nilai_trxIn" value="{{ $data->nilai_trxIn }}">
                            </div>
                        </div>
                        <div class="form-group row">

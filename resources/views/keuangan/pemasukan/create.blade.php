...
@section('title', config('app.name').' | Tambah Transaksi Pemasukan')
    ...
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Tambah Transaksi Pemasukan</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="kd_periode">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">No. Transaksi</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="no_trxIn">
                                    </div>
                                </div>
                                <div class="form-group row" id="data_1">
                                    <label class="col-sm-2 col-form-label">Tanggal Transaksi</label>
                                    <div class="col-sm-10 input-group date">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control" name="tgl_trxIn">
                                    </div>
                                </div>
                                <div class="form-group row">

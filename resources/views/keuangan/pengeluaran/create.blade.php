...
@section('title', config('app.name').' | Tambah Transaksi Pengeluaran')
    ...
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Tambah Transaksi Pengeluaran</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="no_trxOut">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10 input-group date">
                                        <input type="text" id="rupiah" class="form-control" name="nilai_trxOut">
                                    </div>
                                </div>
                                <div class="form-group row">

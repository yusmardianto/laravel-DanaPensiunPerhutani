...
@section('title', config('app.name').' | Master Bank')
...
<script>
    $(function() {
        ...
        $('#table-list').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{!! url('masters/bank/ajax-list') !!}',
                method: 'POST'
            },
            columns: $column,
            columnDefs: [
            ...
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="{{ url('masters/bank/create') }}" class="btn btn-primary btn-xs modal-form">

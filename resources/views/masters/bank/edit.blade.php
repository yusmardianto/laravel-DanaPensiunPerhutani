...
@section('title', config('app.name').' | Ubah Daftar Bank')
    ...
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Ubah Daftar Bank</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="kd_bank" value="{{ $data->kd_bank }}">
                                    </div>
                                </div>
                                <div class="form-group row">

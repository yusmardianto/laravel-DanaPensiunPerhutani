...
@section('title', config('app.name').' | Master Status')
...
<script>
    $(function() {
        ...
        $('#table-list').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{!! url('masters/status/ajax-list') !!}',
                method: 'POST'
            },
            columns: $column,
            columnDefs: [
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            var deleteUrl = "{{ url('masters/status/destroy') }}" + "/" + dataId;
            var csrf = "{{ csrf_token() }}";
            ...
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="{{ url('masters/status/create') }}" class="btn btn-primary btn-xs modal-form">

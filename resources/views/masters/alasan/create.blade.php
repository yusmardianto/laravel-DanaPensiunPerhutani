...
@section('title', config('app.name').' | Tambah Alasan')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="formula_mp">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Jenis SK</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="jenis_sk">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="jenis_sisa_mk">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Usia Faktor Sekarang</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="usia_faktor_sekarang">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Usia Faktor Sekaligus</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="usia_faktor_sekaligus">
                                    </div>
                                </div>
                                <div class="form-group row">

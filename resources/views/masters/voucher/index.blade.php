...
@section('title', config('app.name').' | Master Voucher')
...
<script>
    $(function() {
        ...
        $('#table-list').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{!! url('masters/voucher/ajax-list') !!}',
                method: 'POST'
            },
            columns: $column,
            columnDefs: [
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            var deleteUrl = "{{ url('masters/voucher/destroy') }}" + "/" + dataId;
            var csrf = "{{ csrf_token() }}";
            ...
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="{{ url('masters/voucher/create') }}" class="btn btn-primary btn-xs modal-form">
